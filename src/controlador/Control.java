...
public class Control {
	...
	private StringBuilder letrasFallidas= new StringBuilder(" ");
	private String[] palabras={"transversal","indeterminacion","ademan","termodinamica","autosomico","melancolia","poiquilotermo","iridiscencia","endotermico","luminiscencia","sempiterno","inconmensurable","etereo","inefable","superfluo","efimero"};

	public String getPalabras() {
		return palabras[(int) (palabras.length*Math.random())];
	}
	public void setLetrasFallidas(StringBuilder letrasFallidas) {
		this.letrasFallidas = letrasFallidas;
	}
	public String getLetrasFallidas() {
		return letrasFallidas.toString();
	}
